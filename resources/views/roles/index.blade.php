    ...
    <div class="card text-bg-theme p-3">
        ...
        <div class="card-header pb-0">
            <div class="d-flex flex-row justify-content-between">
                ...
                <a href="{{ route('roles.role.create') }}" class="btn bg-gradient-primary btn-sm mb-0" type="button">+&nbsp; Create New Role</a>
            </div>
        </div>
            ...
            <div class="table-responsive p-0">
                ...
                <div class="d-flex justify-content-between ms-0 mt-4 mb-0">
                    <div class="d-flex justify-content-start ms-2" >
                        <button onclick="exportToExcel('data_table', 'roles')" class="btn bg-gradient-success bt-sm py-0 me-2" style="border-radius: 3em; height: 2.6em " type="button">
                            <span class="btn-inner--icon"><i class="fas fa-file-excel text-sm me-1 text-white"></i></span>
                            <span class="btn-inner--text">XLS</span>
                        </button>
                        <button onclick="exportTableToCSV('data_table', 'roles')" class="btn bg-gradient-info  bt-sm py-0 me-2" style="border-radius: 3em; height: 2.6em " type="button">
                            <span class="btn-inner--icon"><i class="fas fa-file-csv text-sm  me-1  text-white"></i></span>
                            <span class="btn-inner--text">CSV</span>
                        </button>
                        <button onclick="exportTableToPDF('data_table', 'roles')" class="btn bg-gradient-warning  bt-sm py-0 me-2" style="border-radius: 3em; height: 2.6em " type="button">
                        ...
                        <button id="bulk-delete-btn" class="btn bg-gradient-danger bt-sm py-0 ms-2" type="button" style="display:none; border-radius: 3em; height: 2.6em" onclick="bulkDelete('roles')">
    ...
    <div class="d-flex flex-row justify-content-between">
        ...
        <i class="fas fa-sort  text-sm text-secondary" data-bs-placement="top" ></i>
                    ...
                    @foreach($roles as $role)
                        <tr>
                            ...
                            <td class="align-middle text-center">
                                <input type="checkbox" class="row-checkbox" data-id="{{ $role->id }}">
                            </td>

                            
                            <td class="text-start">
                                <p class="text-xs font-weight-bold mb-0 text-wrap">{{ optional($role->team)->name }}</p>
                            </td>


                            <td class="text-start">
                                <p class="text-xs font-weight-bold mb-0 text-wrap">{{ $role->name }}</p>
                            </td>


                            <td class="text-start">
                                <p class="text-xs font-weight-bold mb-0 text-wrap">{{ $role->description }}</p>
                            </td>
                            ...
                            <td class="text-end">
                                ...
                                <input name="_method" value="DELETE" type="hidden">
                                    ...
                                    <td class="text-end">
                                        <a href="{{ route('roles.role.show', $role->id ) }}" class="" data-bs-toggle="tooltip" title="Show role" data-bs-original-title="Show role">
                                            <i class="fas fa-eye  text-sm text-info" data-bs-placement="top" ></i>
                                        </a>

                                        &nbsp;&nbsp;&nbsp;

                                        <a href="{{ route('roles.role.edit', $role->id ) }}" class="" data-bs-toggle="tooltip" title="Edit role" data-bs-original-title="Edit role">
                                            <i class="fas fa-edit text-sm text-primary"  data-bs-placement="top"></i>
                                        </a>

                                        &nbsp;&nbsp;&nbsp;

                                        <button type="button" class="btn text-white delete-button" style="height: 0.2em; width:1em; padding:0em" data-form-id="delete-form-{{ $role->id }}" title="Delete role">
                                            <i class="fas fa-trash text-sm text-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete role"></i>
                                        </button>
            ...
            <div class="mt-3 ms-3 me-4 d-flex justify-content-between align-items-center">
                ...
                <div>
                    {!! $roles->appends(['records_per_page' => request()->input('records_per_page')])->links('pagination') !!}

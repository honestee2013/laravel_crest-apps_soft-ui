    ...
    <div class="card text-bg-theme">
        ...
        <div class="card-header pb-0">
            <div class="d-flex flex-row justify-content-between">
                <div>
                    <h5 class="mb-0">{{ __('Create New Team') }}</h5>
                </div>
        ...
        <div class="card-body">
            ...
            <form method="POST" class="needs-validation" novalidate action="{{ route('teams.team.store') }}" accept-charset="UTF-8" id="create_team_form" name="create_team_form" >
            {{ csrf_field() }}
            @include ('teams.form', [
                                        'team' => null,
                                      ])

...
<x-core.views::layouts.app>
    ...
    <livewire:core.livewire.data-tables.data-table-manager model="App\\Modules\\Production\\Models\\ProductionOrderApproval"
        pageTitle="Manages Production Order Approvals"
        queryFilters=[]
        :hiddenFields="[
            'onTable' => [],
        ]"

...
<x-core.views::layouts.app>
    ...
    <livewire:core.livewire.data-tables.data-table-manager model="App\\Modules\\Production\\Models\\ProductionProcessDowntime"
        pageTitle="Manage Production Log Downtime"
        queryFilters=[]
        :hiddenFields="[
            'onTable' => [],
        ]"

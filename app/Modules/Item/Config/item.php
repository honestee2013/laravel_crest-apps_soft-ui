...
return [
        ...
        "fieldDefinitions"=>[
            ...
            'unit_id' => [
                'field_type' => 'select',
                'options' => app('App\Modules\Item\Models\Unit')->optionList('symbol'),
                'relationship' => [
            ...
            'categories' => [
                'field_type' => 'checkbox',
                'options' => App\Modules\Item\Models\Category::pluck('display_name', 'id')->toArray(),
                'relationship' => [
            ...
            'tags' => [
                'field_type' => 'checkbox',
                'options' => App\Modules\Item\Models\Tag::pluck('display_name', 'id')->toArray(),
                'relationship' => [
            ...
            'item_type_id' => [
                'field_type' => 'select',
                'options' => App\Modules\Item\Models\ItemType::pluck('display_name', 'id')->toArray(),
                'relationship' => [

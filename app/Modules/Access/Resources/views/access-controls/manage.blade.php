    ...
    <x-slot name="sidebar">
        ...
        <div class="card mb-4 mx-4 p-4">
            ...
            <div class="card-body pt-4 p-3">
                        ...
                        <livewire:access.livewire.access-controls.module-selector
                            :selectedScope="$accessController['scope']"
                            :selectedRole="$accessController['id']"
...
<script>
    ...
    function navigateToModule(select) {
        alert(select.value);
        Route::get('/{module}/{scope}/{id}', [AccessController::class, 'manage'])->name('access-control.manage');
